...
def main(args):
    ...
    df = generate_rounded_triangle_sdf_dataset(num_triangle=num_samples,
                                               points_per_triangle=1000,
                                               smooth_factor=smooth_factor,
                                               filename=dataset_path)
    ...
    df = generate_rounded_triangle_sdf_dataset(num_triangle=500,
                                               points_per_triangle=1000,
                                               smooth_factor=smooth_factor,
                                               filename=dataset_path)
    ...
    df = generate_traingle_reconstruction_dataset(num_triangle=n_features_per_shape,
                                                  smooth_factor=smooth_factor,
                                                  filename=dataset_path)
