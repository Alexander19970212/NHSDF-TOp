...
CONFIG_DIR="configs/final_experiments/MMD_VAEs"
MAX_EPOCHS=1  # Adjust as needed
DATASET_PATH="shape_datasets"

METRICS_FILE="src/final_metrics_round1_frst_strtg_MMD_VAEs.json"
METRICS_FILE_RECON="src/final_metrics_round1_frst_strtg_MMD_VAEs_recon.json"
