...
CONFIG_DIR="configs/NN_sdf_experiments/final_experiments/AEs"
MAX_EPOCHS=1  # Adjust as needed
DATASET_PATH="shape_datasets"

METRICS_FILE="src/final_metrics_round4_frst_strtg_AEs.json"
METRICS_FILE_RECON="src/final_metrics_round4_frst_strtg_AEs_recon.json"
...
METRICS_FILE="src/final_metrics_round3_frst_strtg_AEs.json"
METRICS_FILE_RECON="src/final_metrics_round3_frst_strtg_AEs_recon.json"
