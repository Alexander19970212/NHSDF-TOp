...
METRICS_FILE="src/final_metrics_round4_frst_strtg_VAEs.json"
METRICS_FILE_RECON="src/final_metrics_round4_frst_strtg_VAEs_recon.json"
...
METRICS_FILE="src/final_metrics_round3_frst_strtg_VAEs.json"
METRICS_FILE_RECON="src/final_metrics_round3_frst_strtg_VAEs_recon.json"
