...
def create_comparison_table():
    ...
    # result_pathes = [result_pathes_prefix + suffix for suffix in result_pathes_suffixes]
    ...
    # reconstruction_results_pathes = [reconstruction_result_pathes_prefix + suffix for suffix in reconstruction_results_pathes_suffixes]


    recon_suffix = "_recon_dec"
    experiment_indeces = [1, 2, 3, 4]
