...
def create_comparison_table():
    ...
    result_pathes = ["src/final_metrics_round4_frst_strtg_AEs.json",
                     "src/final_metrics_round4_frst_strtg_MMD_VAEs.json",
                     "src/final_metrics_round4_frst_strtg_VAEs.json"
                     ]
    ...
    reconstruction_results_pathes = ["src/final_metrics_round4_frst_strtg_AEs_recon.json",
                                      "src/final_metrics_round4_frst_strtg_MMD_VAEs_recon.json",
                                      "src/final_metrics_round4_frst_strtg_VAEs_recon.json"
                                      ]
